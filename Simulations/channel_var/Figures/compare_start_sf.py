...
file_random = '../results_True_True_1000_100_SF_random.p'
file_sf12 = '../results_True_True_1000_100_SF12.p'
file_sf7 = '../results_True_True_1000_100_SF7.p'
file_random_lower_datarate = '../results_True_True_1000_100_SF_random_lower_datarate_same_uniq_bytes.p'

results = dict()
results['random'] = pickle.load(open(file_random, "rb"))
results['sf12'] = pickle.load(open(file_sf12, "rb"))
results['sf7'] = pickle.load(open(file_sf7, "rb"))
results['random_slow'] = pickle.load(open(file_random_lower_datarate, "rb"))

sigmas = results['random']['path_loss_variances']
payload_sizes = results['random']['payload_sizes']
