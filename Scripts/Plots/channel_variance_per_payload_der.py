...
dir = 'C:/Users/Calle/Documents/GitHub/LoRaEnergySim/Scripts/Simulations/Measurements/ChannelVariance/2sim/adr_conf/'
for p in payload_sizes:
    nodes_df = pd.read_pickle(dir+'/simulation_results_node_{}'.format(p))
    gateway_df = pd.read_pickle(dir+'gateway_results_{}'.format(p))
